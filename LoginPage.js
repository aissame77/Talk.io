          ...
          <form>
            <div className="Style2">
              <div className="Style3">
                <label >Email</label>
                <span>Need an account? <Link to="/SignUpPage" style={{ textDecoration: 'none' }}><span className="spanStyle2" >Sign up</span></Link></span>
              </div>
            ...
            <div className="Style5">
              ...
              <div className="Style7">
                <input className="input2" disabled={ loading || currentUser } ref={passwordRef} type={passwordShown ? "text" : "password"}  />
              </div>
            </div>
          </form>
        </div>
